...
var address = new URLSearchParams(document.location.search).get('kit') || '0x76e069b47b79442657eaf0555a32c6b16fa1b8b4'; //rinkeby
      ...
      document.getElementById('start').addEventListener('click', () => {
        kreditsKit.newInstance().then(transaction => {
          ...
          transaction.wait(1).then(result => {
            ...
            new Kredits(window.ethProvider, window.signer, { addresses: { Kernel: window.daoAddress }}).init()
              .then(kredits => {
